...
<head>
  ...
  <title>Inscription – ARCHEO STAR</title>
  <link rel="stylesheet" href="/FAP/style/inscription.css">
</head>
<body>
  ...
  <div class="header3">
    ...
    <p>Recevez nos actualités et participez à des visites exclusives.</p>
  </div>
    ...
    <div class="card">
        <form action="/FAP/html/inscription.php" method="POST">
            <div>
...
<script>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $host = 'mysql:host=localhost;dbname=archeo_it;';
        $login = 'root';
        $password = '';
        $options = [
        ...
        try {
            ...
            if (
                ...
                if (!empty($errors)) {
                    ...
                    $stmt = $pdo->prepare("INSERT INTO utilisateurs (lastname, firstname, email, password, gender, street, number, city, postal_code) 
